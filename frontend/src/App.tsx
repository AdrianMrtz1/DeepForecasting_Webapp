  ...
  const forecastTableRows = useMemo(
    ...
    () =>
      ...
      forecastRows.data.map((row) => {
        ...
        const interval = forecastRows.intervals[0];

        const bounds = interval ? row.bounds?.[interval] : undefined;
                      ...
                      <>
                        <div className="mt-3">
                          {forecastTableRows.length ? (
                            <ForecastDataTable data={forecastTableRows} />
                          ) : (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <button
                                    ...
                                    className="rounded-lg border border-rose-200 px-3 py-1 text-xs font-semibold text-rose-700 transition hover:bg-rose-50 dark:border-rose-500/40 dark:text-rose-200"
